...
def seed_images():
    image1 = Image(userId = 1, albumId = 1, tagId = 1, content="cloud above ocean", description="untouched by the earth's impurity the sky is vast and empty more than the oceanwhich is full of many mysteries",
    ...
    image3 = Image(userId = 1, albumId = 1, tagId = 1, content="Islands", description="Crystal clear water of the sea",
    ...
    image4 = Image(userId = 1, albumId = 1, tagId = 1, content="Mountains over the sea", description="Mountains give me peace and the ocean makes people restless",
    ...
    image5 = Image(userId = 1, albumId = 1, tagId = 2, content="Hopeful Horizons", description="Keep your eyes on the horizon. Where the sun melts into the sea. Someday, we will get there.",
    ...
    image6 = Image(userId = 1, albumId = 1, tagId = 2, content="Never Lost", description="See the beauty, today is new",
    ...
    image7 = Image(userId = 2, albumId = 2, tagId = 3, content="Travel in Germany", description="Try to travel, otherwise you end up believing",
    ...
    image8 = Image(userId = 2, albumId = 2, tagId = 3, content="Paris", description="Favorite city forever",
    ...
    image9 = Image(userId = 2, albumId = 2, tagId = 3, content="Sunset in Burano", description="A glorious sunset over the Venetian lagoon. Taken from the harbour of Burano.",
    ...
    image10 = Image(userId = 2, albumId = 2, tagId = 3, content="Winding through London", description="Live. Love. London",
    ...
    image11 = Image(userId = 2, albumId = 2, tagId = 3, content="Old canals of Suzhou", description="All you need is love and a vacation in Suzhou.",
    ...
    image12 = Image(userId = 2, albumId = 2, tagId = 3, content="Shanghai", description="By seeing Shanghai, I have seen as much of life as the world can show.",
    ...
    image13 = Image(userId = 3, albumId = 3, tagId = 4, content="Cutie", description="A simple moment as each week-end when I am home with my wife and my little cat.",
    ...
    image14 = Image(userId = 3, albumId = 3, tagId = 5, content="Dessert", description="Delicious cake with pistachio and raspberries",
    ...
    image15 = Image(userId = 3, albumId = 3, tagId = 6, content="A wonderful night in Provence", description="To walk alone in Provence is the greatest rest",
